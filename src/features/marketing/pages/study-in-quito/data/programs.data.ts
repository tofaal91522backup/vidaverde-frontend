...
export const programs: Program[] = [
  {
    ...
    schedule: [
      {
        day: "Mon – Fri",
        activity: "Spanish classes (9am – 1pm)",
        type: "Class",
      },
      {
        day: "Mon – Fri",
        activity: "Cultural activity or guided walk (1:30pm)",
        type: "Activity",
      },
      { day: "Tuesday", activity: "Quito Colonial tour", type: "Included" },
      {
        day: "Wednesday",
        activity: "Cooking or crafts class",
        type: "Included",
      },
      { day: "Thursday", activity: "Museum visit", type: "Included" },
      {
        day: "Weekend",
        activity: "Optional excursions (Otavalo, Cotopaxi, Mindo)",
        type: "Optional",
      },
    ],
    pricingNote:
    ...
    pricing: [
      ...
      {
        duration: "1 week + homestay",
        price: "$582",
        note: "Classes + 7 nights",
      },
      {
        duration: "2 weeks + homestay",
        price: "$1,078",
        note: "Classes + 14 nights",
      },
    ],
    testimonial: {
      quote:
  ...
  },
  {
    ...
    pricePeriod: " / person",
    heroImage:
      "https://images.unsplash.com/photo-1578894381163-e72c17f2d45f?w=1400&q=80",
    included: [
    ...
    schedule: [
      {
        day: "Day 1–3",
        activity: "Quito. Orientation and city classes",
        type: "Class + City",
      },
      {
        day: "Day 4–6",
        activity: "Amazon lodge. Jungle immersion",
        type: "Adventure",
      },
      {
        day: "Day 7–9",
        activity: "Pacific coast. Beach and whale-watching",
        type: "Adventure",
      },
      {
        day: "Day 10–12",
        activity: "Return to Quito. Final classes",
        type: "Class",
      },
    ],
    pricingNote: "All prices in USD per person. Minimum 2 participants.",
    pricingFooter:
      "Solo travel rates available on request. Contact us for a custom itinerary.",
    pricing: [
  ...
  },
  {
    ...
    schedule: [
      ...
      {
        day: "Afternoons",
        activity: "Beach, town exploration, local culture",
        type: "Free",
      },
      {
        day: "Weekend",
        activity: "Whale-watching or Isla de la Plata (seasonal)",
        type: "Optional",
      },
    ],
    pricingNote:
      "All prices in USD per person, per week. To be confirmed. Contact us for current rates.",
    pricingFooter:
      "Accommodation can be arranged nearby. Contact us for a personalised quote.",
    pricing: [
      {
        duration: "1 week",
        price: "$[X]",
        note: "Classes only. Confirm with Vida Verde",
      },
      {
        duration: "2 weeks",
        price: "$[X]",
