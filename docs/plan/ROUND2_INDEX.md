...
- **Status:** planned — kono step shuru hoy nai
...
|---|---|---|---|---|
| **Auth** | [ROUND2_AUTH_INTEGRATION.md](ROUND2_AUTH_INTEGRATION.md) | 0–6 (7 ta) | Student registration backend-e **ekhon ache** — ager blocker khule gese | 🔴 1 |
| **Public** | [ROUND2_PUBLIC_INTEGRATION.md](ROUND2_PUBLIC_INTEGRATION.md) | 0–4 (5 ta) | Booking flow order bodleche + package-e teacher restriction | 🟠 2 |
...
**Ekhon kothay:** kono step shuru hoy nai. Prothom `next` → **Auth Step 0**.
