...
- **Status:** in progress — Auth shesh, Public cholche (10/18 step)
...
**Ekhon kothay:** ✅ Auth shesh. Public cholche — Step 0-2 done (boro step ta shesh). Porer `next` → **Public Step 3**.
