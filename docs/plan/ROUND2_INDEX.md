...
- **Status:** in progress — Auth shesh, Public cholche (11/18 step)
...
**Ekhon kothay:** ✅ Auth shesh. Public cholche — Step 0-3 done. Porer `next` → **Public Step 4** (section-er shesh step).
